...
from clearpath_base.msg import Joy, Announce

rospy.init_node('clearpath_teleop', anonymous=True)
...
announce_pub.publish(action="new_joy", topic=rospy.get_namespace());
